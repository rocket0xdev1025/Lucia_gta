      ...
      t.default = class SwiperHandler {
        ...
        applyMotionPreferences(e) {
          return window.matchMedia("(prefers-reduced-motion: reduce)").matches
            ? Object.assign({}, e, { speed: 0, autoplay: !1 })
            : e;
        }
      };
    },
      ...
      var r = n(8612),
        ...
        b = function DOMException() {
          ...
          var e = arguments.length,
            ...
            o = new v(t);
          return (
            (o.name = g), a(r, "stack", i(1, m(o.stack, 1))), c(r, this, b), r
          );
        },
        ...
        constructor() {
          super(),
            elementorFrontend.elementsHandler.attachHandler("text-path", () =>
              Promise.all([n.e(786), n.e(30)]).then(n.bind(n, 241))
            );
        }
      }
      t.default = _default;
